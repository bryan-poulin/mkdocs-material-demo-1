...
Supporting blog post for @james-willett **Material for MKDocs: Full Tutorial to Build And Deploy Your Docs Portal** on :simple-youtube: [YouTube](https://www.youtube.com/watch?v=xlABhbnNrfI).
...
- A GitHub Action will trigger that deploys the site
    - For example [https://bryan-poulin.github.io/mkdocs-material-demo-1-2024/](https://bryan-poulin.github.io/mkdocs-material-demo-1/)